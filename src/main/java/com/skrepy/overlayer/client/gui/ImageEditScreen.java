...
import com.skrepy.overlayer.client.gui.components.FabricSlider;
...
public class ImageEditScreen extends Screen {
    ...
    private FabricSlider xSlider;
    private FabricSlider ySlider;
    private FabricSlider rotationSlider;
    private FabricSlider scaleSlider;
    private FabricSlider alphaSlider;
    ...
    // ========== 自定义滑块内部类（标记修改） ==========
    private class XSlider extends FabricSlider {
        ...
        protected void onValueChanged(double value) {
            entry.setXOffset((int) value);
        }
    }

    private class YSlider extends FabricSlider {
        ...
        @Override
        protected void onValueChanged(double value) {
            entry.setYOffset((int) value);
        }
    }

    private class RotationSlider extends FabricSlider {
        ...
        @Override
        protected void onValueChanged(double value) {
            entry.setRotation((int) value);
        }
    }

    private class ScaleSlider extends FabricSlider {
    ...
    private class AlphaSlider extends FabricSlider {
        private double lastVal = Double.MIN_VALUE;
